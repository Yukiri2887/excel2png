 ...
 * <p>
 */
public class DrawFromExcelTest {
     ...
     */
    public static void excelToImage(String convertFile, String path) throws IOException, InvalidFormatException {
//        try {
//            path = URLDecoder.decode(path, "UTF-8");
//        } catch (UnsupportedEncodingException e) {
//            e.printStackTrace();
//        }
        Workbook wb = WorkbookFactory.create(new File(convertFile));
        wb.close();
        // 获取每个Sheet表
